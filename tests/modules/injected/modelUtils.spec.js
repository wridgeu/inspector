...
describe('modelUtils', function () {
    ...
    describe('#getModels()', function () {
        ...
        it('should mark the models UI5 names with a leading $ as internal', function () {
            stubSapUi(
            ...
            models.filter(function (row) { return row.name === '$componentState'; })[0].internal.should.equal(true);
